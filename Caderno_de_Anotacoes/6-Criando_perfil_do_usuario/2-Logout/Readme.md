...
Qnd faz logout, não precisa redirecionar, pois o reducer do auth de sign_out
troca o token pra null e signed pra false. Como lá no início em App.js o redux
lê o estado de auth, ao alterar o estado, as rotas são re-renderizadas.
